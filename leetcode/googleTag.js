...
// Fetch data for all questions and save to a CSV file
async function main() {
    ...
    const csv = json2csvParser.parse(Object.values(final_data));

    // Write CSV data to a file
    const csvFilePath = 'H:/surbhi/dsa/leetcode/data.csv'; // Specify the file path here
    fs.writeFileSync(csvFilePath, csv);
    console.log(`CSV data has been saved to ${csvFilePath}`);
}
