...
const HEADERS = {
    ...
    'Referer': 'https://leetcode.com/company/google',
...
async function getQuestionList() {
    try {
        const response = await axios.get("https://leetcode.com/company/google")
...
async function leech(question) {
    ...
    try {
        ...
        r.url = "https://leetcode.com/company/google";
...
// Main function to fetch data for all questions and save to a JSON file
async function main() {
